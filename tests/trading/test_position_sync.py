...
class TestClosePositionIntraday:
    ...
    @patch("trading.positions.intraday.record_closed_position")
    @patch("trading.positions.intraday.delete_position_meta")
    @patch("trading.positions.intraday.load_position_meta")
...
class TestUpdateFillPrices:
    ...
    @pytest.mark.asyncio
    @patch("trading.positions.intraday.save_position_meta")
    @patch("trading.positions.intraday.load_all_position_meta")
