...
from db.positions import load_current_signals, load_positions
...
from trading.scheduler_prepare import run_scan_core
...
async def run_daily_scan(
    ...
    from trading.scheduler_actions import run_risk_evaluation
