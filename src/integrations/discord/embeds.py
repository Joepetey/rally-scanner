...
def _stream_degraded_embed(disconnected_minutes: int) -> dict:
    ...
    return {
        ...
        "color": _ORANGE,
        "description": (
            f"The Alpaca WebSocket stream has been disconnected "
            f"for **{disconnected_minutes} min**.\n"
...
def _stream_recovered_embed(downtime_minutes: int) -> dict:
    ...
    return {
        ...
        "color": _GREEN,
        "description": (
            f"The Alpaca WebSocket stream has reconnected "
            f"after **{downtime_minutes} min** of downtime.\n"
